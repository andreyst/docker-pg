...
WHISPER_DIR = '/data/graphite-carbon/whisper'
RRD_DIR = '/data/graphite-carbon/rrd'
#DATA_DIRS = [WHISPER_DIR, RRD_DIR] # Default: set from the above variables
LOG_DIR = '/var/log/graphite-web'
INDEX_FILE = '/data/graphite-web/storage/index'  # Search index file
...
DATABASES = {
    'default': {
        'NAME': '/data/graphite-web/storage/graphite.db',
